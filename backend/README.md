...
## Project Structure
    ...
    ├── testapiautoteammemb_69235  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_69235`
...
2. Clone this repo and `cd testapiautoteammemb_69235`
